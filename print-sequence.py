...
cmd_resize_SL =  "pdfjam --outfile {} --paper a4paper {}".format(shadow_library_pdf_a4, shadow_library_pdf) # resize pdf to A4
...
print('ps. .... I will add an ANNEX for you as well, to leak some information from the making process. Hope you will enjoy it!', asciiart['flames2'], file=stdout)
